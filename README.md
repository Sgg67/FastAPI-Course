...
- Role-based permissions (e.g. only session hosts can cancel a session)
- Email verification on registration
- Filtering/sorting courts by price or facility type
- Pagination for court and session listings
